...
export const ArrowTrendingUp = ({ variant = "outline" }: IconProps) => {
  switch (variant) {
    case "outline":
      return (
        <svg
        ...
        >
          <path
            d="M2.25 18L9 11.25L13.3064 15.5564C14.5101 13.1881 16.5042 11.2023 19.1203 10.0375L21.8609 8.81732M21.8609 8.81732L15.9196 6.53668M21.8609 8.81732L19.5802 14.7586"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
